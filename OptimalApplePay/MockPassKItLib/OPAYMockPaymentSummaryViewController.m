...
#import "OPAYMockDataTableViewController.h"
#import "OPAYMockCardStore.h"
#import "OPAYMockAddressStore.h"
#import "OPAYMockShippingMethodStore.h"
...
@interface OPAYMockPaymentSummaryViewController () <UITableViewDataSource, UITableViewDelegate>
...
@property (nonatomic) OPAYMockCardStore *cardStore;
@property (nonatomic) OPAYMockAddressStore *billingAddressStore;
@property (nonatomic) OPAYMockAddressStore *shippingAddressStore;
@property (nonatomic) OPAYMockShippingMethodStore *shippingMethodStore;
@property (nonatomic) NSArray *sectionTitles;
@property (weak, nonatomic) IBOutlet UIButton *cancelButton;
@end

@implementation OPAYMockPaymentSummaryViewController
...
- (instancetype)initWithPaymentRequest:(PKPaymentRequest *)paymentRequest {
    ...
    if (self) {
        ...
        _cardStore = [OPAYMockCardStore new];
        _billingAddressStore = [OPAYMockAddressStore new];
        _shippingAddressStore = [OPAYMockAddressStore new];
        _shippingMethodStore = [[OPAYMockShippingMethodStore alloc] initWithShippingMethods:paymentRequest.shippingMethods];
...
- (IBAction)makePayment:(id)sender {
   // self.payButton.hidden = YES;
    ...
    OPAYMockApplePayDef.selectedCardNumber=[card objectForKey:@"number"];
...
- (void)configureCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    id<OPAYMockDataStore> store = [self storeForSection:title];
...
- (id<OPAYMockDataStore>)storeForSection:(NSString *)section {
    id<OPAYMockDataStore> store;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    id<OPAYMockDataStore> store = [self storeForSection:self.sectionTitles[indexPath.section]];
    OPAYMockDataTableViewController *controller = [[OPAYMockDataTableViewController alloc] initWithStore:store];
