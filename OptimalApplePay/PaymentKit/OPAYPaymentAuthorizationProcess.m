...
@interface OPAYPaymentAuthorizationProcess ()  <UIViewControllerTransitioningDelegate,NSURLConnectionDelegate,PKPaymentAuthorizationViewControllerDelegate,OPAYMockPaymentAuthorizationProcessDelegate>
{
...
@property(nonatomic, retain)OPAYMockPaymentAuthorizationProcess *testPaymentAuthorizationProcess;

@end

@implementation OPAYPaymentAuthorizationProcess
...
-(void)beginPayment:(UIViewController *)viewController withRequestData:(NSDictionary*)dataDictionary withCartData:(NSDictionary*)cartData
{
    ...
    #if __IPHONE_OS_VERSION_MAX_ALLOWED >= 80000
    {
        ...
        {
            if ([OPAYPayment canSubmitPaymentRequest:paymentRequest])
            {
                                ...
                                completion:(void (^)(PKPaymentAuthorizationStatus status))completion
{
    ...
    OPAYRequestApplePaySingleUseTokens *applePaySingleUseTokens=[[OPAYRequestApplePaySingleUseTokens alloc]init];
